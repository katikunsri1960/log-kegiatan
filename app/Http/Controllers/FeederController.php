...
use App\Models\Feeder\ListMahasiswa;

class FeederController extends Controller
{
    public function lulusan(Request $req)
    {
        ...
        return view('feeder.lulusan', compact('mahasiswaFix', 'totalPerYear', 'mahasiswaPerStatus', 'angkatan', 'status'));
    }
}
