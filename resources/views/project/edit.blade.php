                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 p-9 border">
                                    <form class="form-horizontal" method="POST" action="{{route(request()->segment(1).'.update', $data->id)}}">
                                        @method('PUT')
                                        @csrf
                                        <div class=" row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control @error('name')
                                                    is-invalid
                                                @enderror" name="name" placeholder="Project Name" value="{{$data->name}}">
                                                @error('name')
                                        ...
                                        <div class=" row mb-4">
                                            <label class="col-md-3 form-label">Progress</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control @error('progress')
                                                    is-invalid
                                                @enderror" name="progress" placeholder="progress" value="{{$data->progress}}">
                                                @error('progress')
                                                <span class="invalid-feedback text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class=" row mb-4 mb-0">
                                            ...
                                            @enderror" name="user_id[]"
                                                    ...
                                                    <option value="{{$user->id}}" @if (in_array($user->id, $data->users->pluck('id')->toArray()))
                                                        selected
